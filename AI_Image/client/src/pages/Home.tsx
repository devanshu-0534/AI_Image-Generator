...
function Home() {
    ...
    return (
        <>
            <Header />
            <div className="container mx-auto max-w-screen-xl px-2 bg-black">
                <h1 className="mt-16 pb-7 sm:mt-20 animate-text text-center bg-gradient-to-r from-purple-500 via-green-500 bg-clip-text text-transparent text-5xl sm:7xl font-black">
                    Convert Thinks to Image With AI Image Generator
                </h1>
                <p className="text-center text-purple-500">
                    Unlock your Thoughts with our power of computer-generated images by AI!
                </p>
                <div className="max-w-screen-xl mt-10 mx-auto">
                    ...
                    <div className="pl-1">
                        ...
                        <button
                            className="btn btn-xs sm:btn-sm btn-outline capitalize bg-white"
                            onClick={() => {
