...
const ImageModal: React.FC<ImageModalProps> = ({
    ...
    return (
        <>
            ...
            >
                <div className="modal-box relative bg-gray-500" ref={modalRef}>
                    <label
                    ...
                    <div className="modal-action">
                        {isCopied ? (
                            ...
                            <button
                                type="button"
                                className="btn gap-2 capitalize btn-outline border border-white hover:bg-black text-black"
                        ...
                        {isDownloaded ? (
                            ...
                            <button
                                type="button"
                                className="btn gap-2 capitalize border-2 bg-gradient-to-r border-white text-black "
